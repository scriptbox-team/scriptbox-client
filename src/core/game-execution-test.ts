 ...
 * @class Game
 */
export default class GameExecution {
     ...
     */
    public start() {
        this._loginInterface.setURL("::1:9000");
     ...
     *
     * @private
     * @param {string} address The game server address.
     * @memberof GameExecution
     */
    ...
    private _tick() {
        ...
        if (this._networkSystem.connected) {
            ...
            const message = ">> Math.cos(Math.random()) * Math.sin(Math.random())";
